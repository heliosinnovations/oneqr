        ...
        <div className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-gray-700">
                  <li>
                    <strong>Free:</strong> Generate unlimited QR codes, download
              ...
              <div>
                ...
                <p className="text-gray-700">
                  When you pay to make a QR code editable, you can change where
                  it points without reprinting it. For example, if you printed
                  QR codes on business cards, you can update the destination URL
                  to point to a new website, portfolio, or offer—without
                  reprinting the cards.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Never. Once you generate a QR code, it works forever. Even the
                  free ones.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-gray-700">
                  ...
                  <li>
                    <strong>SVG:</strong> Vector format for scaling to any size
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Yes! QR codes are a universal standard supported by all modern
                  smartphones (iPhone, Android) without needing an app.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="mb-2 text-xl font-semibold">How do I log in?</h3>
                <p className="text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Yes. All data is encrypted in transit (HTTPS) and at rest. We
                  use industry-standard security practices.
                </p>
              </div>

              <div>
                <h3 className="mb-2 text-xl font-semibold">Do you show ads?</h3>
                <p className="text-gray-700">
                  Yes, we display subtle ads to cover hosting costs.
                  They&apos;re non-intrusive and placed at the top and bottom of
                  the homepage.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  If it&apos;s an editable QR code, check your dashboard to see
                  what URL it&apos;s set to. If it&apos;s a free QR code, you
                  may have entered the wrong URL when creating it.
                </p>
              </div>
          ...
          <section className="mt-12 border-t pt-8">
            <h2 className="mb-4 font-serif text-3xl">Still Have Questions?</h2>
