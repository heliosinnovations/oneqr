        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc space-y-2 pl-6">
              ...
              <li>
                <strong>QR Code Metadata:</strong> Creation date, edit history,
                and scan analytics for your saved QR codes
              </li>
            </ul>
          ...
          <section className="mb-12">
            <h2 className="mb-4 font-serif text-3xl">How We Store Your Data</h2>
            <ul className="list-disc space-y-2 pl-6">
              <li>
          ...
          <section className="mb-12">
            <h2 className="mb-4 font-serif text-3xl">Changes to This Policy</h2>
            <p>
