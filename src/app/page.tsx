      ...
      <main id="main-content" className="min-h-screen bg-bg">
        ...
        >
          <div className="mx-auto max-w-6xl">
            ...
            >
              <li className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-sm transition-all duration-300 hover:border-accent/30 hover:bg-white/[0.06] lg:p-10">
                <div className="absolute right-0 top-0 h-32 w-32 translate-x-8 translate-y-[-50%] rounded-full bg-accent/10 blur-3xl transition-all duration-500 group-hover:bg-accent/20" />
                <div
                  className="relative mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-accent/20 to-accent/5 text-2xl ring-1 ring-accent/20"
                  role="img"
                ...
                <div className="relative mt-6 flex items-center gap-2 text-xs font-medium text-accent">
                  <span className="rounded-full bg-accent/10 px-3 py-1">Up to 4K</span>
                  <span className="rounded-full bg-white/5 px-3 py-1 text-white/50">Print-ready</span>
                </div>
              </li>
              ...
              <li className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-sm transition-all duration-300 hover:border-accent/30 hover:bg-white/[0.06] lg:p-10">
                ...
                <div className="relative mt-6 flex flex-wrap items-center gap-2 text-xs font-medium">
                  <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">PNG</span>
                  <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">SVG</span>
                  <span className="rounded-full bg-white/5 px-3 py-1 text-white/50">PDF</span>
                  <span className="rounded-full bg-white/5 px-3 py-1 text-white/50">EPS</span>
                </div>
              </li>
              ...
              <li className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-sm transition-all duration-300 hover:border-accent/30 hover:bg-white/[0.06] lg:p-10">
                ...
                <div className="relative mt-6 flex items-center gap-2 text-xs font-medium text-accent">
                  <span className="rounded-full bg-accent/10 px-3 py-1">72-600 DPI</span>
                  <span className="rounded-full bg-white/5 px-3 py-1 text-white/50">Size calc</span>
                </div>
              </li>
              ...
              <li className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-sm transition-all duration-300 hover:border-accent/30 hover:bg-white/[0.06] lg:p-10">
                ...
                <div className="relative mt-6 flex flex-wrap items-center gap-2 text-xs font-medium">
                  <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">6 patterns</span>
                  <span className="rounded-full bg-accent/10 px-3 py-1 text-accent">9 styles</span>
                  <span className="rounded-full bg-white/5 px-3 py-1 text-white/50">Gradients</span>
                </div>
              </li>
            </ul>
