          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p>
                ...
                ), operated by Helios Innovations, you agree to be bound by
            ...
            <section className="mb-12">
              ...
              <p>
                To save QR codes to your dashboard, you must create an account
                by providing a valid email address. We use magic link
                authentication — no passwords are required.
              </p>
              ...
              <ul className="list-disc space-y-2 pl-6">
                <li>
                  You are responsible for maintaining access to your email
                </li>
            ...
            <section className="mb-12">
              ...
              <p>
                You retain ownership of the URLs and content you link to via
                your QR codes. By using our service, you grant us a limited
                license to process and store this information solely to provide
                the service.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc space-y-2 pl-6">
                ...
                <li>
                  QR codes you generate are permanent — they do not expire or
                  stop working
                </li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="mt-4">
                ...
                you paid us in the past 12 months, or $100, whichever is
                greater.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="mt-4">
                ...
                immediately. QR codes you have already generated will continue
                to function.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p>
                ...
                these terms shall be resolved in the courts of the United
                States.
              </p>
            </section>
